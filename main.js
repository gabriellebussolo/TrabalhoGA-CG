document.addEventListener('DOMContentLoaded', () => {
    ...
    let xTrans = 0, yTrans = 0, zTrans = -6;
...
function loadMesh(gl) {
    ...
    if (typeof OBJ === 'undefined') {
        console.error('OBJ loader not defined, seems the library did not load correctly.');
        return null;
    }
...
function drawScene(gl, programInfo, mesh, xRot, yRot, zRot, xTrans, yTrans, zTrans) {
